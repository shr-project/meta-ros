...
RDEPENDS:${PN}-jscal = "bash busybox gawk"
...
RDEPENDS:${PN}-jscal:append:class-target_webos = " ${VIRTUAL-RUNTIME_bash}"
RDEPENDS:${PN}-jscal:remove:class-target_webos = "${@oe.utils.conditional('WEBOS_PREFERRED_PROVIDER_FOR_BASH', 'busybox', 'bash', '', d)}"
