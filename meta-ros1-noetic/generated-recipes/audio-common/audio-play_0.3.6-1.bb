...
# matches with: https://github.com/ros-gbp/audio_common-release/archive/release/noetic/audio_play/0.3.6-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/audio_play"
SRC_URI = "git://github.com/ros-gbp/audio_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "2363db8a603941174bc910b372e0af65fbd93e4d"
S = "${WORKDIR}/git"
