...
# matches with: https://github.com/ros-gbp/bond_core-release/archive/release/noetic/bond_core/1.8.5-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/bond_core"
SRC_URI = "git://github.com/ros-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "6df7e67b043cb468395cd2fc19322f7bee49aac4"
S = "${WORKDIR}/git"
