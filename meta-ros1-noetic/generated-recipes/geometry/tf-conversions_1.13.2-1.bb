...
ROS_BUILD_DEPENDS = " \
    ${ROS_UNRESOLVED_PLATFORM_PKG_liborocos-kdl-dev} \
    geometry-msgs \
    kdl-conversions \
    libeigen \
    tf \
...
ROS_EXEC_DEPENDS = " \
    ${ROS_UNRESOLVED_PLATFORM_PKG_liborocos-kdl} \
    ${ROS_UNRESOLVED_PLATFORM_PKG_python3-pykdl} \
    geometry-msgs \
    kdl-conversions \
    libeigen \
    tf \
...
# matches with: https://github.com/ros-gbp/geometry-release/archive/release/noetic/tf_conversions/1.13.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/tf_conversions"
SRC_URI = "git://github.com/ros-gbp/geometry-release;${ROS_BRANCH};protocol=https"
SRCREV = "9b79b25a854924ec5643ce60c319626a7c80a24c"
S = "${WORKDIR}/git"
