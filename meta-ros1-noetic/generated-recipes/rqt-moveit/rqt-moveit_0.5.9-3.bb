...
# matches with: https://github.com/ros-gbp/rqt_moveit-release/archive/release/noetic/rqt_moveit/0.5.9-3.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rqt_moveit"
SRC_URI = "git://github.com/ros-gbp/rqt_moveit-release;${ROS_BRANCH};protocol=https"
SRCREV = "0a0b2b810d5657634bb2fd40415dcfd34ee8938f"
S = "${WORKDIR}/git"
