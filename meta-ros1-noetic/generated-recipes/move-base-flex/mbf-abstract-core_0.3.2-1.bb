...
# matches with: https://github.com/uos-gbp/move_base_flex-release/archive/release/noetic/mbf_abstract_core/0.3.2-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/mbf_abstract_core"
SRC_URI = "git://github.com/uos-gbp/move_base_flex-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5ad7b547234d1ef17c977249408a22ceeb87fdd"
S = "${WORKDIR}/git"
