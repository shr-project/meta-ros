...
# matches with: https://github.com/ros-gbp/kdl_parser-release/archive/release/noetic/kdl_parser/1.14.0-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/kdl_parser"
SRC_URI = "git://github.com/ros-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "464b080af78ebd6c4605a35de2ba3db682455a82"
S = "${WORKDIR}/git"
