...
ROS_BUILD_DEPENDS = " \
    ${ROS_UNRESOLVED_PLATFORM_PKG_libboost-chrono-dev} \
...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roscpp/1.15.7-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/roscpp"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "8481203a247236869ca3f852c8dcd7055227a5fb"
S = "${WORKDIR}/git"
