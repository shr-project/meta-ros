...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosservice/1.15.7-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosservice"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "5757bf854237a2c601bb2bc73926cff08b0b3b73"
S = "${WORKDIR}/git"
