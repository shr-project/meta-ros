...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag_storage/1.15.7-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/rosbag_storage"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "ef2ed59844e8993575ca3bcbcc45b7cfc9bb77af"
S = "${WORKDIR}/git"
