...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/topic_tools/1.15.7-1.tar.gz
ROS_BRANCH ?= "branch=release/noetic/topic_tools"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "6f2a4e880ec7dd2899406717c99441e74320548c"
S = "${WORKDIR}/git"
